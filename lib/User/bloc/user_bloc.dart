...
class UserBloc implements Bloc {
  ...
  Future<void> updateMilanesaData(Milanesa milanesa) =>
      _cloudFirestoreRepository.updateMilanesaData(milanesa);
  Stream<QuerySnapshot> milanesasListStream =
      Firestore.instance.collection(CloudFirestoreApi().MILANESAS).snapshots();
  Stream<QuerySnapshot> get milanesasStream => milanesasListStream;
  List<ProfileMilanesa> buildMilanesas(
          List<DocumentSnapshot> milanesasListSnapshot) =>
      _cloudFirestoreRepository.buildMilanesas(milanesasListSnapshot);
